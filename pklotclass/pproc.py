...
default_cycler = (cycler(color=['mediumblue', 'darkblue', 'firebrick', 'darkred']) + cycler(linestyle=['-', '--', '-', '--']))
plt.rc('axes', prop_cycle=default_cycler)

label_dict = {'accuracy': 'Accuracy', 'loss': '$\mathcal{L}$', 'TPR': 'TPR', 'TNR': 'TNR', 'PPV': 'PPV', 'NPV': 'NPV'}
